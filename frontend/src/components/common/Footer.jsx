      ...
      <div className="container">
        <div className="row mb-5">
          <div className="col-md-3">
            <img src={logoWhite} alt="" width={150} className="footer-logo" />
            <div className="pt-3 pe-4">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam
              consectetur adipisci corporis, cumque magnam harum libero
              blanditiis.
            </div>
          </div>
          <div className="col-md-3">
        ...
        <div className="row spotlight py-5 justify-content-center">
